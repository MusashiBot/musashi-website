...
.border-musashi-blue\\/20 {
  border-color: rgb(168 197 221 / 0.2);
}
.border-red-500\\/30 {
...
.bg-musashi-blue {
  --tw-bg-opacity: 1;
  background-color: rgb(168 197 221 / var(--tw-bg-opacity, 1));
}
.bg-musashi-blue\\/10 {
  background-color: rgb(168 197 221 / 0.1);
}
.bg-red-50 {
  --tw-bg-opacity: 1;
...
.text-musashi-blue {
  --tw-text-opacity: 1;
  color: rgb(168 197 221 / var(--tw-text-opacity, 1));
}
.text-red-600 {
  --tw-text-opacity: 1;
...
/* ==============================================
   MUSASHI DESIGN SYSTEM - Glassmorphism
   ============================================== */

:root {
  /* Primary Colors - Cloud Dancer (soft blue-gray) */
  --musashi-primary: #A8C5DD;
  --musashi-primary-light: #C4D9E8;
  --musashi-primary-dark: #8BAFC9;
  --musashi-primary-glow: rgba(168, 197, 221, 0.2);
  ...
  --category-politics: #1D9BF0;
  --category-crypto: #F59E0B;
  --category-economics: #10B981;
  --category-sports: #EF4444;
  --category-technology: #1D9BF0;
  --category-entertainment: #EC4899;
  --category-climate: #14B8A6;

  /* Semantic Colors */
  --yes-color: #10B981;
  --yes-bg: rgba(16, 185, 129, 0.1);
  --no-color: #EF4444;
  --no-bg: rgba(239, 68, 68, 0.1);
...
/* Glass Panel - Main Sidebar */
/* Flat minimal panel - no glass effect */
.glass-panel {
  background: rgba(255, 255, 255, 0.97);
  border: 1px solid rgba(168, 197, 221, 0.15);
...
.twitter-native-card:hover {
  border-color: rgb(180, 190, 195);
  background: rgb(247, 249, 249);
}

/* Prevent Twitter's link styles from affecting our card */
.twitter-native-card * {
...
.musashi-market-pill {
  ...
  border: 1px solid rgba(168, 197, 221, 0.25);
  font-size: 11px;
  font-weight: 500;
  cursor: pointer;
...
.musashi-market-pill:hover {
  border-color: #A8C5DD;
  background: #FFFFFF;
}

/* Minimal category pills - very subtle */
.musashi-pill-politics {
  background: rgba(168, 197, 221, 0.08);
  border-color: rgba(168, 197, 221, 0.25);
}
...
.musashi-pill-technology {
  background: rgba(168, 197, 221, 0.08);
  border-color: rgba(168, 197, 221, 0.25);
}

.musashi-pill-entertainment {
  background: rgba(236, 72, 153, 0.08);
  border-color: rgba(236, 72, 153, 0.25);
}

.musashi-pill-climate {
...
.animate-spring {
  animation: springBounce 400ms cubic-bezier(0.34, 1.56, 0.64, 1);
}
...
.animate-fade-slide-up {
  animation: fadeSlideUp 300ms cubic-bezier(0.4, 0, 0.2, 1);
}
...
/* Sidebar scrollbar */
.musashi-sidebar-content::-webkit-scrollbar {
  width: 4px;
}

.musashi-sidebar-content::-webkit-scrollbar-track {
  background: transparent;
}

.musashi-sidebar-content::-webkit-scrollbar-thumb {
  background: rgba(139, 92, 246, 0.3);
  border-radius: 2px;
}

.musashi-sidebar-content::-webkit-scrollbar-thumb:hover {
...
/* Prevent Twitter style inheritance */
.musashi-isolated,
.musashi-isolated * {
  all: initial;
  font-family: var(--font-family) !important;
...
/* ==============================================
   DARK MODE
   Twitter has three themes: Default (white), Dim (#15202B), Lights Out (#000).
   The .musashi-dark class is applied by JS when body luminance is below 100.
   ============================================== */

/* Card shell */
.musashi-dark .twitter-native-card {
  background: #16181c !important;
  border-color: #2f3336 !important;
}
.musashi-dark .twitter-native-card:hover {
  background: #1c1f23 !important;
  border-color: #3b4046 !important;
}

/* Primary text — market title */
.musashi-dark .text-gray-900 { color: #e7e9ea !important; }
/* Gray number (non-winning side) */
.musashi-dark .text-gray-700 { color: #b9c0c7 !important; }
/* Labels: "Yes" / "No" / platform / "Prediction Market" */
.musashi-dark .text-gray-500 { color: #71767b !important; }
/* Muted metadata: % match, resolve date, volume */
.musashi-dark .text-gray-400 { color: #536471 !important; }
/* Separator dot between footer items */
.musashi-dark .text-gray-300 { color: #3b4046 !important; }

/* Vertical divider line between YES and NO */
.musashi-dark .bg-gray-200   { background-color: #2f3336 !important; }

/* YES winning — lighter green for dark background */
.musashi-dark .text-green-600 { color: #34d399 !important; }
/* NO winning — lighter red for dark background */
.musashi-dark .text-red-600   { color: #f87171 !important; }

/* 24h change pill — positive */
.musashi-dark .text-green-700 { color: #34d399 !important; }
.musashi-dark .bg-green-50    { background-color: rgba(52, 211, 153, 0.15) !important; }
/* 24h change pill — negative */
.musashi-dark .text-red-700   { color: #f87171 !important; }
.musashi-dark .bg-red-50      { background-color: rgba(248, 113, 113, 0.15) !important; }

/* Probability bar track */
.musashi-dark .musashi-prob-bar { background: rgba(255, 255, 255, 0.1) !important; }

/* ==============================================
   SECONDARY MARKETS — EXPAND / COLLAPSE
   ============================================== */

/* Expand trigger — mimics Twitter's quiet "show more" style */
.musashi-expand-btn {
  display: block;
  background: none;
  border: none;
  ...
  /* Reset any inherited button styles from Twitter */
  outline: none;
  -webkit-appearance: none;
}

.musashi-expand-btn:hover {
  color: #1d9bf0;
}

/* Dark mode expand button */
.musashi-dark .musashi-expand-btn        { color: #536471; }
.musashi-dark .musashi-expand-btn:hover  { color: #1d9bf0; }

/* Smooth expand via grid — avoids max-height jank when height is unknown */
.musashi-secondary-cards {
  display: grid;
  grid-template-rows: 0fr;
  transition: grid-template-rows 300ms cubic-bezier(0.4, 0, 0.2, 1);
}

.musashi-secondary-expanded {
  grid-template-rows: 1fr;
}

/* Inner wrapper must have overflow:hidden for grid trick to clip content */
.musashi-secondary-cards > div {
  overflow: hidden;
  display: flex;
  flex-direction: column;
  gap: 0;
...
/* Each secondary card gets a top margin only when visible */
.musashi-secondary-item {
  margin-top: 8px;
}
...
/* Track — near-invisible gray, implies the "no" side through absence */
.musashi-prob-bar {
  height: 3px;
  border-radius: 9999px;
...
/* Fill — yes probability, grows from left */
.musashi-prob-bar-fill {
  height: 100%;
  border-radius: 9999px;
...
.musashi-flash-up {
  animation: flash-up 1s ease-out forwards;
}

.musashi-flash-down {
  animation: flash-down 1s ease-out forwards;
}

.hover\\:text-musashi-blue-dark:hover {
  --tw-text-opacity: 1;
  color: rgb(139 175 201 / var(--tw-text-opacity, 1));
}
...
;// ./src/content/twitter-extractor.ts
...
;// ./src/api/musashi-api-client.ts
// Musashi API Client
// Handles communication with the Musashi backend API
class MusashiApiClient {
    constructor(baseUrl = 'https://musashi-api.vercel.app', apiKey) {
...
const musashiApi = new MusashiApiClient(
// Production API URL
...
;// ./src/sidebar/TwitterNativeCard.tsx


const TwitterNativeCard = ({ market, confidence, tweetText, matchedKeywords = [], }) => {
    const [barWidth, setBarWidth] = (0,react.useState)(0); // starts at 0 for entry animation
    ...
    return (react.createElement("a", { href: `${market.url}?ref=musashi`, target: "_blank", rel: "noopener noreferrer", className: "twitter-native-card", onClick: (e) => {
            e.stopPropagation();
            console.log('[Musashi] User clicked market card:', market.title);
        } },
        react.createElement("div", { className: "flex items-center justify-between mb-2" },
            react.createElement("div", { className: "flex items-center gap-2" },
                react.createElement("span", { className: "text-xs text-gray-500 font-normal" }, "Prediction Market"),
                react.createElement("span", { className: "text-xs text-gray-400" }, "\u2022"),
                react.createElement("span", { className: "text-xs text-gray-500 font-normal" }, market.platform === 'polymarket' ? 'Polymarket' : 'Kalshi'),
                sentiment && sentiment.confidence > 0 && (react.createElement(react.Fragment, null,
                    react.createElement("span", { className: "text-xs text-gray-400" }, "\u2022"),
                    react.createElement("div", { className: "w-1.5 h-1.5 rounded-full", style: {
                            backgroundColor: sentiment.sentiment === 'bullish' ? '#10B981' :
            ...
            react.createElement("span", { className: "text-xs text-gray-400" },
                ...
                "% match")),
        react.createElement("h3", { className: "text-sm font-normal text-gray-900 leading-snug mb-2" }, market.title),
        react.createElement("div", { className: "flex items-center gap-4 mb-2" },
            react.createElement("div", { className: "flex items-center gap-2 px-2 py-0.5 rounded-md" },
                react.createElement("span", { className: "text-xs text-gray-500 uppercase tracking-wide" }, "Yes"),
                react.createElement("span", { className: `text-lg font-semibold ${isYesWinning ? 'text-green-600' : 'text-gray-700'}` },
                    yesPercent,
                    "%"),
                isYesWinning && (react.createElement("svg", { className: "w-3.5 h-3.5 text-green-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                    react.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M5 15l7-7 7 7" })))),
            react.createElement("div", { className: "w-px h-6 bg-gray-200" }),
            react.createElement("div", { className: "flex items-center gap-2 px-2 py-0.5 rounded-md" },
                react.createElement("span", { className: "text-xs text-gray-500 uppercase tracking-wide" }, "No"),
                react.createElement("span", { className: `text-lg font-semibold ${!isYesWinning ? 'text-red-600' : 'text-gray-700'}` },
                    noPercent,
                    "%"),
                !isYesWinning && (react.createElement("svg", { className: "w-3.5 h-3.5 text-red-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                    react.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M19 9l-7 7-7-7" })))),
            changeLabel && (react.createElement("span", { className: `ml-auto text-xs font-medium px-1.5 py-0.5 rounded ${dayChange > 0
                    ? 'text-green-700 bg-green-50'
                    : 'text-red-700 bg-red-50'}` }, changeLabel))),
        react.createElement("div", { className: "musashi-prob-bar" },
            react.createElement("div", { className: "musashi-prob-bar-fill", style: { width: `${barWidth}%` } })),
        (endDateLabel || volumeLabel) && (react.createElement("div", { className: "flex items-center gap-1.5 mt-2" },
            endDateLabel && (react.createElement("span", { className: "text-xs text-gray-400" },
                "Resolves ",
                endDateLabel)),
            endDateLabel && volumeLabel && (react.createElement("span", { className: "text-xs text-gray-300" }, "\u00B7")),
            volumeLabel && (react.createElement("span", { className: "text-xs text-gray-400" }, volumeLabel))))));
};
/* harmony default export */ const sidebar_TwitterNativeCard = (TwitterNativeCard);

;// ./src/content/inject-twitter-card.tsx
/* unused harmony import specifier */ var React;
/* unused harmony import specifier */ var inject_twitter_card_TwitterNativeCard;



// Track which tweets have cards injected
const injectedTweets = new Map();
/**
 ...
 */
function applyThemeToAllCards(theme) {
 ...
 */
const MarketCardGroup = ({ primary, secondary, tweetText }) => {
    const [expanded, setExpanded] = (0,react.useState)(false);
    return (react.createElement("div", null,
        react.createElement(sidebar_TwitterNativeCard, { market: primary.market, confidence: primary.confidence, tweetText: tweetText, matchedKeywords: primary.matchedKeywords }),
        secondary.length > 0 && (react.createElement(react.Fragment, null,
            react.createElement("button", { className: "musashi-expand-btn", onClick: (e) => { e.stopPropagation(); e.preventDefault(); setExpanded(v => !v); } }, expanded
                ? 'show less'
                : `+ ${secondary.length} more market${secondary.length > 1 ? 's' : ''}`),
            react.createElement("div", { className: `musashi-secondary-cards${expanded ? ' musashi-secondary-expanded' : ''}` },
                react.createElement("div", null, secondary.map(m => (react.createElement("div", { key: m.market.id, className: "musashi-secondary-item" },
                    react.createElement(sidebar_TwitterNativeCard, { market: m.market, confidence: m.confidence, tweetText: tweetText, matchedKeywords: m.matchedKeywords }))))))))));
};
/**
 * Inject Twitter-native market card inline within tweet
 * Appears below tweet text, like Twitter's native link previews
 */
function injectTwitterCard(tweetElement, match, tweetText, secondaryMatches = []) {
    ...
    const root = client.createRoot(cardContainer);
    root.render(react.createElement(react.StrictMode, null,
        react.createElement(MarketCardGroup, { primary: match, secondary: secondaryMatches, tweetText: tweetText })));
    // Track injection
 ...
 */
function updateTwitterCard(tweetElement, match, tweetText) {
    const existing = injectedTweets.get(tweetElement);
    if (existing) {
        const { market, confidence, matchedKeywords } = match;
        existing.root.render(React.createElement(React.StrictMode, null,
            React.createElement(inject_twitter_card_TwitterNativeCard, { market: market, confidence: confidence, tweetText: tweetText, matchedKeywords: matchedKeywords })));
    }
    else {
 ...
 */
function removeTwitterCard(tweetElement) {
    const existing = injectedTweets.get(tweetElement);
    if (existing) {
 ...
 * Remove all cards
 */
function removeAllTwitterCards() {
 ...
 */
function hasTwitterCard(tweetElement) {
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/sidebar/sidebar.css
var sidebar = __webpack_require__(773);
...
const analyzedTweetCache = new Map();
...
function setCachedAnalysis(text, matches) {
        ...
        setTimeout(() => {
            extractor.start(async (tweets) => {
                ...
                for (const tweet of tweets) {
                    ...
                    let matches = getCachedAnalysis(tweet.text);
                    if (matches === null) {
                    ...
                    if (matches.length > 0) {
                        ...
                        console.log(`[Musashi ${source}] MATCH ${(best.confidence * 100).toFixed(0)}% — "${best.market.title}"` +
                ...
                if (injected > 0)
                    console.log(`[Musashi] Injected ${injected} card(s)`);
                const unique = new Map();
                allMatches.forEach(m => {
                    const ex = unique.get(m.market.id);
                    if (!ex || m.confidence > ex.confidence)
                        unique.set(m.market.id, m);
                });
...
async function loadMarketsFromServiceWorker() {
